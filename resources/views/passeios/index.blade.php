    ...
    <div class="relative min-h-screen flex flex-col bg-cover bg-center"
        ...
        <div class="relative z-10 py-10 fade-in">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <a href="{{ route('passeios.create') }}"
                    class="mb-6 inline-block bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-500 hover:to-red-600 font-semibold px-5 py-2 rounded-lg shadow-md hover:scale-105 transform transition duration-300">
                    <i class="bi bi-plus-square-dotted"></i> Novo Passeio
                </a>

                <a href="{{ route('passeios.tours') }}"
                    class="mb-6 inline-block bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-500 hover:to-red-600 font-semibold px-5 py-2 rounded-lg shadow-md hover:scale-105 transform transition duration-300">
                    <i class="bi bi-plus-square-dotted"></i> Ver Passeios
                </a>
                                    ...
                                    <div class="flex p-4 gap-4 items-start">
                                        ...
                                        <div class="flex flex-col justify-between items-end space-y-2 text-sm">
                                            ...
                                            <div class="flex flex-col text-sm text-right mt-6">
                                                ...
                                                <a href="{{ route('passeios.edit', $passeio) }}" class="text-yellow-500"><i class="bi bi-pencil-square text-xl"></i></a>
                                                <form action="{{ route('passeios.destroy', $passeio) }}" method="POST">
                                                    @csrf @method('DELETE')
                                    ...
                                    <div class="flex flex-col p-4 gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="mt-2 text-sm text-gray-600 dark:text-gray-300 space-y-2">
                                                <div><i class="bi bi-geo-alt"></i> {{ $passeio->destino ?? '—' }}</div>
                                                <div><i class="bi bi-clock"></i> {{ $passeio->duracao_dias }} dias</div>
                                                <div class="text-green-600 font-semibold"><i class="bi bi-cash"></i>{{ number_format($passeio->preco, 2, ',', '.') }} Kz</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pt-2 border-t border-gray-200 dark:border-gray-700 flex flex-col gap-2">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <a href="{{ route('passeios.show', $passeio) }}" class="text-blue-600" aria-label="Ver {{ $passeio->nome }}">
                                            ...
                                            <div class="flex gap-2">
                                                <a href="{{ route('passeios.edit', $passeio) }}" class="flex-1 text-center py-2 rounded bg-yellow-50 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-100">Editar</a>

                                                <form action="{{ route('passeios.destroy', $passeio) }}" method="POST" class="flex-1" onsubmit="return confirm('Tem certeza?')">
                                                    @csrf @method('DELETE')
