...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a]
    ...
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        ...
        <nav class="flex items-center justify-end gap-4">
            ...
            <a
                href="{{ url('/dashboard') }}"
                class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal flex items-center gap-1">
                <i class="bi bi-speedometer2 animate-slowPulse"></i> Dashboard
            </a>
            @else
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-2">
                <i class="bi bi-geo-alt-fill text-yellow-500 animate-float"></i>
                Bem-vindo(a) ao Sul de Angola
            </h2>
            <a href="{{ route('login') }}"
          ...
          hover:bg-[#a48f3e] hover:text-black hover:border-yellow-500 dark:hover:bg-gray-200 dark:hover:text-black">
                <i class="bi bi-box-arrow-in-right animate-swing"></i> Login
            </a>
    ...
    <div class="flex items-center justify-center w-full lg:grow">
        <div class="container">
            ...
            <div class="relative bg-cover bg-center h-screen"
                style="background-image: url('assets/img/Serra_Leba.jpg');">
                <div class="absolute inset-0 bg-black bg-opacity-50"></div>

                <div class="relative z-10 flex flex-col items-center justify-center h-full w-full text-center text-white px-6">

                    <h1 class="text-4xl font-bold mb-4 flex items-center gap-2">
                        <i class="bi bi-geo-alt-fill text-yellow-400 animate-slowPulse"></i>
                        Descubra a beleza da Huíla e Namibe
                    </h1>

                    <p class="max-w-2xl text-lg mb-6">
                        Bem-vindo à cidade das montanhas e vales encantadores.
                        Explore as maravilhas naturais como a Serra da Leba, o Cristo Rei, os deslumbrantes miradouros da Huíla e outros pontos turísticos que estas províncias podem oferecer.
                        Venha viver experiências únicas de cultura, aventura e hospitalidade angolana.
                    </p>
                    <a href="{{ route('corridas.create') }}"
                        class="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold rounded-lg shadow-lg transition transform hover:-translate-y-1 hover:shadow-xl flex items-center gap-2 overflow-hidden">
