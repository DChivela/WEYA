<x-app-layout>
    <div class="relative min-h-screen flex items-center justify-center bg-cover bg-center"
         style="background-image: url('/assets/img/restaurante.jpg');">
        <!-- camada de escurecimento + desfoque -->
        ...
        <style>
            @keyframes pulse {
                0%, 100% { opacity: 0.7; text-shadow: 0 0 10px rgba(255,255,255,0.6); }
                50% { opacity: 1; text-shadow: 0 0 25px rgba(255,255,255,0.9); }
            }
            ...
            /* Para browsers que não suportam backdrop-filter */
            /*Efeito para desfocar */
            .backdrop-blur-sm {
